...
public class MyDate {
    ...
    public static boolean isStringParsableToDate(String expression, String format) {
        try {
...
//            e.printStackTrace();
    ...
    public static boolean isDateParsableToString(Date expression, String format) {
        try {
            SimpleDateFormat date = new SimpleDateFormat(format, Locale.ENGLISH);
